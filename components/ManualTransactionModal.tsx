    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl w-full max-w-md flex flex-col">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 uppercase mb-1 block">Amount ({currency})</label>
            <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 font-mono text-lg">{currency}</span>
                <input
                    type="number"
                    autoFocus
                    placeholder="0.00"
                    ...
                    className="w-full bg-slate-800 border border-slate-600 rounded-lg py-2 pl-8 pr-3 text-white text-lg font-bold focus:outline-none focus:border-indigo-500"
          ...
          <div>
            ...
            <div className="relative">
                <AlignLeft size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" />
                <input
                    type="text"
                    placeholder="e.g. Grocery Shopping"
                    value={data.description}
                    onChange={e => setData({ ...data, description: e.target.value })}
                    className="w-full bg-slate-800 border border-slate-600 rounded-lg py-2 pl-9 pr-3 text-white text-sm focus:outline-none focus:border-indigo-500"
                    onKeyDown={(e) => e.key === 'Enter' && handleSubmit()}
                />
            </div>
          </div>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        className="w-full bg-slate-800 border border-slate-600 rounded-lg py-2 pl-9 pr-3 text-white text-sm focus:outline-none focus:border-indigo-500 appearance-none"
                    >
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 uppercase mb-1 block">Source</label>
            <div className="relative">
        ...
        <div className="p-6 pt-0">
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-700 disabled:text-slate-500 text-white font-bold py-3 rounded-xl shadow-lg shadow-indigo-500/20 transition-all flex items-center justify-center gap-2"
          >
